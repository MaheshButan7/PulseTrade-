...
export default function Signup(){
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden">
            <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl -z-10 animate-blob"></div>
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl -z-10 animate-blob" style={{ animationDelay: '2s' }}></div>
            ...
            <div className="p-8 bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl w-96 shadow-[0_0_50px_rgba(0,0,0,0.5)] flex flex-col gap-4 relative z-10">
                <h1 className="text-3xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 flex justify-center tracking-tight">Create Account</h1>
                <p className="text-gray-400 text-sm text-center mb-4">Start trading crypto with Pulse Trade</p>
